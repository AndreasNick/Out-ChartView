...
function Set-WPFChartTitel
{
	...
	(
		...
		[string]$Titel,
		[String]$FontSize = "10",
		[System.Windows.FontWeights]$FontWeights = [System.Windows.FontWeights]::Bold,
		[System.Windows.Media.Brushes]$Foreground = [System.Windows.Media.Brushes]::White,
		[String]$Height = "15"
...
<#
    .Synopsis
    Create a Grapf with Random Data
    .DESCRIPTION
...
function Add-WPFChartData
{
	...
	begin
	{
		...
		$Series1.Foreground = "white"
		$Series1.Background = "white"
